...
export declare type PDFViewerOptions = import('pdfjs-dist/types/web/pdf_viewer').PDFViewerOptions;
export interface PDFProgressData {
    loaded: number;
    total: number;
}
export declare type ZoomScale = 'page-height' | 'page-fit' | 'page-width';
